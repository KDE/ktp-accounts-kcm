...
public:
    explicit SipeAccountUi(QObject *parent = nullptr);
    ...
    AbstractAccountParametersWidget* advancedOptionsWidget(ParameterEditModel *model, QWidget *parent = nullptr) const override;
